...
p8 <- ggplot(dat, aes(log_catch_by_TAC)) +
  ...
  geom_segment(y=-45, yend=-45, x=-2.5, xend=2.5, lwd=0.8, colour="grey30", lineend="square") +
  geom_segment(y=0, yend=1000, x=-2.75, xend=-2.75, lwd=0.8, colour="grey30", lineend="square") +
  scale_x_continuous(breaks=seq(-2.5, 2.5, 2.5), limits=c(-2.5,2.5)) +
  scale_y_continuous(breaks=seq(0, 1000, 500), limits=c(0, 1000)) +
  theme_classic(base_size=12) +
  theme_bw() + 
  theme(panel.border = element_blank(), 
        panel.grid.major = element_blank(), 
...
p9 <- ggplot(dat, aes(tac_change)) +
  ...
  geom_segment(y=-342, yend=-342, x=0, xend=50, lwd=0.8, colour="grey30", lineend="square") +
  geom_segment(y=0, yend=7000, x=-3.8, xend=-3.8, lwd=0.8, colour="grey30", lineend="square") +
...
p10 <- ggplot(dat, aes(log_tac_change)) +
  ...
  geom_segment(y=-200, yend=-200, x=-5, xend=5, lwd=0.8, colour="grey30", lineend="square") +
...
p2 <- ggplot(dat, aes(council, catch_by_TAC)) + 
  ...
  geom_segment(x=0.4, xend=0.4, y=0, yend=9, lwd=0.8, colour="grey30", lineend="square") +
  geom_segment(y=-0.42, yend=-0.42, x=1, xend=24, lwd=0.8, colour="grey30", lineend="square") +
  scale_y_continuous(breaks=seq(0, 9, 3), limits=c(0, 9)) +
  labs(x="Region", y="Catch/TAC") +
  theme_classic(base_size=12) +
  theme_bw() + 
  theme(panel.border = element_blank(), 
        panel.grid.major = element_blank(), 
        ...
        axis.line.x = element_blank(),
        axis.text.y   = element_text(size=24),
        axis.text.x   = element_text(size=24, angle = 60, vjust = 1, hjust=1),
        axis.title.y  = element_text(size=26),
...
p3 <- ggplot(dat, aes(DemersPelag, catch_by_TAC)) + 
  #geom_point(size = .8, alpha = .2, position = position_jitter(seed = 1, width = .1)) +
  #ggdist::stat_halfeye(adjust = .5, width = .6, .width = 0, justification = -.2, point_colour = NA) +
  #geom_point(shape = "|", size = 1, alpha = .2) +
  ...
  stat_summary(fun.y = median, fun.ymax = length, geom = "text", aes(label = ..ymax..), vjust = -1, col="blue") +
  geom_segment(x=0.4, xend=0.4, y=0, yend=9, lwd=0.8, colour="grey30", lineend="square") +
  geom_segment(y=-0.42, yend=-0.42, x=1, xend=9, lwd=0.8, colour="grey30", lineend="square") +
  scale_y_continuous(breaks=seq(0, 9, 3), limits=c(0, 9)) +
  labs(x="Habitat", y="Catch/TAC") +
  theme_classic(base_size=12) +
  theme_bw() + 
  theme(panel.border = element_blank(), 
        panel.grid.major = element_blank(), 
...
p4 <- ggplot(dat, aes(x=log_tac_change, y=catch_by_TAC)) +
  geom_point(size=3, shape=21) +
  labs(x="log(TAC change+1)", y="Catch/TAC") +
  geom_segment(y=-0.4, yend=-0.4, x=-5, xend=5, lwd=0.8, colour="grey30", lineend="square") +
  geom_segment(y=0, yend=9, x=-5.49, xend=-5.49, lwd=0.8, colour="grey30", lineend="square") +
  scale_x_continuous(breaks=seq(-5, 5, 2.5), limits=c(-5,5)) +
  scale_y_continuous(breaks=seq(0, 9, 3), limits=c(0, 9)) +
  theme_classic(base_size=12) +
  theme_bw() + 
...
p5 <- ggplot(dat, aes(year, catch_by_TAC)) + 
  geom_boxplot() +
  stat_summary(fun.y = median, fun.ymax = length, geom = "text", aes(label = ..ymax..), vjust = -1, colour="blue") +
  geom_segment(x=0.45, xend=0.45, y=0, yend=9, lwd=0.8, colour="grey30", lineend="square") +
  geom_segment(y=-0.42, yend=-0.42, x=1, xend=59, lwd=0.8, colour="grey30", lineend="square") +
  scale_y_continuous(breaks=seq(0, 9, 3), limits=c(0, 9)) +
  scale_x_discrete(breaks=c(1964, 1973, 1983, 1993, 2003, 2013, 2022)) +
  labs(x="Year", y="Catch/TAC") +
  theme_classic(base_size=12) +
  theme_bw() + 
  theme(panel.border = element_blank(), 
        panel.grid.major = element_blank(), 
...
jpeg("Data_visulization.jpeg", height = 24, width = 18, units='in', res=400)
p
dev.off()
